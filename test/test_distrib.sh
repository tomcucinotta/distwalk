...
for dist in unif:min=20,max=40 exp:20 exp:20,min=10,max=40 norm:20,std=5 norm:20,std=5,min=10,max=40 lognorm:3,std=1 lognorm:xavg=3,xstd=1 gamma:20,k=1,scale=2 gamma:20,k=2,scale=2 aseq:min=1000,max=2000 aseq:min=1000,max=2000,step=250; do
