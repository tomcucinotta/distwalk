...
../src/dw_node_debug -b :7000 --nt $NUM_THREADS &> /tmp/dw_node_cross_fwd_L.log &
NODEPID_L=$!
../src/dw_node_debug -b :7001 --nt $NUM_THREADS &> /tmp/dw_node_cross_fwd_R.log &
NODEPID_R=$!
...
do
	../src/dw_client_debug -b :800$i --to :7000 -C 1000 -F :7001 -C 2000 -n 5 &> /tmp/dw_client_cross_fwd_LR_$i.log &
    CLIENTPIDS_LR[${i}]=$!
done
...
do
    ../src/dw_client_debug -b :900$i --to :7001 -C 1000 -F :7000 -C 2000 -n 5 &> /tmp/dw_client_cross_fwd_RL_$i.log &
    CLIENTPIDS_RL[${i}]=$!
done
