...
# log files
nosync_log=$(mktemp /tmp/disk-seq-write-nosync-$disk_type$OPT_RATE_STR-XXX.log)
...
taskset -c 0,1 ../src/dw_client -S 1000,nosync -n 300 $OPT_RATE &> $nosync_log 
taskset -c 0,1 ../src/dw_client -S 1000,sync -n 300 $OPT_RATE &> $sync_log
...
taskset -c 0,1 ../src/dw_client -S 1000,nosync -n 300 $OPT_RATE &> $psync_nowait_log
taskset -c 0,1 ../src/dw_client -S 1000,sync -n 300 $OPT_RATE &> $psync_wait_log
kill $nodepid &> /dev/null
